        ...
        <form action="/addEmployees" method="POST">
            ...
            <div class="row">
                <div class="col-6">
                    <div class="mb-3">
                        ...
                        <input type="text" name="age" class="form-control" id="exampleFormControlInput1" placeholder="">
                      </div>
                </div>
                <div class="col-6">
                    <div class="mb-3">
            ...
            <div class="row mt-5 mb-5">
                <div class="col-12 text-center">
                    <button href="" type="submit" class="button1" style="text-decoration: none; width: 200px">Add Employee</button>
