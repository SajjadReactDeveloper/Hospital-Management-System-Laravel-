...
<body>
    ...
    <div class="container mt-5">
        <h3>Edit Employee</h3>
        <form action="/editEmployees" method="POST">
            @csrf
            <div class="row">
            ...
            <div class="row">
                <div class="col-6">
                    <div class="mb-3">
                        ...
                        <input type="text" name="ID" value="{{ $data['ID'] }}" disabled id="" class="form-control">
                    </div>
                </div>
                <div class="col-6">
                    <div class="mb-3">
            ...
            <div class="row">
                <div class="col-6">
                    <div class="mb-3">
                        ...
                        <input type="text" name="age" value="{{ $data['age'] }}" class="form-control" id="exampleFormControlInput1" placeholder="">
                      </div>
                </div>
                <div class="col-6">
                    <div class="mb-3">
