...
<body>
    ...
    <div class="container mt-5">
        <h3>Add Doctor</h3>
        <form action="/addDoctors" method="POST" enctype="multipart/form-data">
            @csrf
            <div class="row">
                <div class="col-6">
                    <div class="mb-3">
                ...
                <div class="col-6">
                    <div class="mb-3">
                        ...
                        <input type="text" name="degree" class="form-control" id="exampleFormControlInput1" placeholder="Degree">
                      </div>
                </div>
            </div>
            <div class="row">
            ...
            <div class="row">
                <div class="col-6">
                    <div class="mb-3">
                        ...
                        @foreach ($data as $specialist)
                            <option selected value="{{ $specialist['name'] }}">{{ $specialist['name'] }}</option>
                        @endforeach
                    </select>
                    </div>
                </div>
                <div class="col-2">
                    ...
                    <input type="number" name="charges" id="" class="form-control">
                </div>
                <div class="col-4">
                    <div class="mb-3">
                        <label for="" class="form-label">Department</label>
                        <select class="form-select" aria-label="Default select example" name="department">
                            @foreach ($data1 as $department)
            ...
            <div class="row mt-5 mb-5">
                <div class="col-12 text-center">
                    <button type="submit" href="" class="button1" style="text-decoration: none; width: 200px">Add Doctor</button>
