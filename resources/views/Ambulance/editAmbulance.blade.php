...
<body>
    ...
    <div class="container mt-5">
        ...
        <form action="/editAmbulance" method="POST" enctype="multipart/form-data">
            @csrf
            <div class="row">
            ...
            <div class="row">
                <div class="col-6">
                    <div class="mb-3">
                        ...
                        <input type="text" name="id" value="{{ $data['id'] }}" disabled class="form-control" id="exampleFormControlInput1" placeholder="">
                      </div>
                </div>
                <div class="col-6">
                    <div class="mb-3">
            ...
            <div class="row">
                <div class="col-6">
                    <div class="mb-3">
                        ...
                        <input type="text" name="number" value="{{ $data['number'] }}" class="form-control" id="exampleFormControlInput1" placeholder="">
                      </div>
                </div>
                <div class="col-6">
                    <div class="mb-3">
            ...
            <div class="row mt-5 mb-5">
                <div class="col-12 text-center">
                    <button href="" class="button1" type="submit" style="text-decoration: none; width: 200px">Save Changes</button>
