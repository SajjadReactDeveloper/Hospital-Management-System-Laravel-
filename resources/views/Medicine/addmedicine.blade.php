            ...
            <div class="row">
                ...
                <div class="col-6">
                    <div class="mb-3">
                        ...
                        <input type="text" name="quantity" class="form-control" id="exampleFormControlInput1" placeholder="">
                      </div>
                </div>
            </div>
            <div class="row">
                <div class="col-6">
                    <div class="mb-3">
                        ...
                        <input type="text" name="alert" id="" class="form-control">
                    </div>
                </div>
                <div class="col-6">
                    <div class="mb-3">
            ...
            <div class="row">
                <div class="col-12">
                    <div class="mb-3">
                        ...
                        <textarea class="form-control" name="usages" id="exampleFormControlTextarea1" rows="3"></textarea>
                    </div>
                </div>
            </div>
            <div class="row mt-5 mb-5">
                <div class="col-12 text-center">
                    <button href="" type="submit" class="button1" style="text-decoration: none; width: 200px">Add Medicine</button>
