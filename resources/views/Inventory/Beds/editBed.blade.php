...
<body>
    ...
    <div class="container w-50" style="margin-top: 100px">
        <h4>Edit Bed Seat</h4>
        <form action="/editBeds" method="POST" enctype="multipart/form-data">
            @csrf
            <div class="row">
            ...
            <div class="text-center mt-3">
                <button type="submit" style="background-color: green; width: 250px; font-size: 24px; border-radius: 100px; color: white; padding: 10px; border: none">Save Changes</button>
            </div>
        </form>
    </div>
</body>
