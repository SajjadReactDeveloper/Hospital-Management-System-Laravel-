...
<body>
    ...
    <div class="container mt-5">
        <h3>Add Patient</h3>
        <form action="/addPatients" method="POST" enctype="multipart/form-data">
            @csrf
            <div class="row">
                <div class="col-6">
                    <div class="mb-3">
                ...
                <div class="col-6">
                    <div class="mb-3">
                        ...
                        <div class="form-check form-check-inline mt-2">
                            <input class="form-check-input" type="radio" name="gender" id="inlineRadio3" value="Active">
                            <label class="form-check-label" for="inlineRadio4">Male</label>
                        </div>
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" type="radio" name="gender" id="inlineRadio4" value="Inactive">
            ...
            <div class="row">
                ...
                <div class="col-6">
                    <div class="mb-3">
                        ...
                        <input type="text" name="home" id="" class="form-control">
                    </div>
                </div>
            </div>
            <div class="row">
                ...
                <div class="row">
                    ...
                    <div class="col-6">
                        <div class="mb-3">
                            ...
                            <input type="text" name="pAddress" id="" class="form-control">
                        </div>
                    </div>
                </div>
                <div class="row">
            ...
            <div class="row mt-5 mb-5">
                <div class="col-12 text-center">
                    <button href="" type="submit" class="button1" style="text-decoration: none; width: 200px">Add Patient</button>
